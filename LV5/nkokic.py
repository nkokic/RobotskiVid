...
totalIterations = [20, 50, 100, 200]
pointPairs = [50, 100, 200, 500]

##################################################################

for i, p in product(totalIterations, pointPairs):
    ...
    icp.SetMaximumNumberOfIterations(i) #Željeni broj iteracija
    icp.SetMaximumNumberOfLandmarks(p) #Koliko parova točaka da se koristi prilikom minimiziranja cost funkcije
    ...
    window.SetWindowName(f"Iterations: {i} | Pairs: {p} | Time: {totalTime} s") #Naziv prozora
